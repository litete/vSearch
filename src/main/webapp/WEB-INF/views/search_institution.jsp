...
<link rel="shortcut icon" href="img/f.ico" mce_href="img/f.ico" type="image/x-icon">
    <link rel="bookmark" href="img/f.ico" mce_href="img/fs.ico" type="image/x-icon">    
...
<body>
	...
	<div class="container">
		<div class="col-lg-8">
			<div id="institution" style="height: 300px; width: 100%"></div>
					...
					<div class="col-lg-9 text-center">
						...
						<table class="table table-hover">
							<c:forEach items="${gzitems}" var="item">
								<tr>
									<td align="left"><a target="_blank" href="">${item.name}</a>
									</td>
								</tr>
							</c:forEach>
						</table>
	...
	<script type="text/javascript">
		...
		require([ 'echarts', 'echarts/chart/force' ], function(ec) {
			...
			var myChart = ec.init(document.getElementById('institution'));
			var categories = [];
			var option = {
				title : {
					text : "${title}",
